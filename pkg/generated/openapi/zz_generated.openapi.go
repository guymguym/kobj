...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/kobj-io/kobj/pkg/apis/kobj/v1alpha1.Kobj":            schema_pkg_apis_kobj_v1alpha1_Kobj(ref),
		"github.com/kobj-io/kobj/pkg/apis/kobj/v1alpha1.KobjList":        schema_pkg_apis_kobj_v1alpha1_KobjList(ref),
...
func schema_pkg_apis_kobj_v1alpha1_Kobj(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Kobj TODO",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"data": {
						SchemaProps: spec.SchemaProps{
							Description: "Data is the object content",
							Type:        []string{"string"},
							Format:      "byte",
						},
					},
...
func schema_pkg_apis_kobj_v1alpha1_KobjList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "KobjList TODO",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#lists-and-simple-kinds",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"),
						},
					},
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is the list content",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kobj-io/kobj/pkg/apis/kobj/v1alpha1.Kobj"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kobj-io/kobj/pkg/apis/kobj/v1alpha1.Kobj", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
