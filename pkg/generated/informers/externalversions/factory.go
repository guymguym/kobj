...
import (
	...
	kobj "github.com/kobj-io/kobj/pkg/generated/informers/externalversions/kobj"
...
func (f *sharedInformerFactory) Kobj() kobj.Interface {
	return kobj.New(f, f.namespace, f.tweakListOptions)
}
